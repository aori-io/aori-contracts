...
contract AoriProtocolE2ETest is DSTest {
    ...
    uint256 SERVER_PRIVATE_KEY = 1; // To be re-set in setUp
    ...
    address SERVER_WALLET = address(vm.addr(SERVER_PRIVATE_KEY)); // To be re-set in setUp
    ...
    function setUp() public {
        ...
        aoriProtocol = IAoriProtocol(vm.envAddress("AORI_PROTOCOL_ADDRESS"));

        SERVER_PRIVATE_KEY = uint256(vm.envBytes32("SERVER_PRIVATE_KEY"));
        SERVER_WALLET = vm.addr(SERVER_PRIVATE_KEY);
